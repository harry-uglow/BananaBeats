...
\end{itemize}
After much discussion, we decided to work on creating a touch-pad sound controller using fruit as the touch-pads. This would allow the users of sound controller to create music in a more quirky way whilst helping us to develop our programming skills in a field that we have little experience in. 
